...
const botaoDeDescansoCurto = document.querySelector('.app__card-button--curto');
const botaoDeDescansoLongo = document.querySelector('.app__card-button--longo');
...
botaoDeDescansoCurto.addEventListener('click', () => {
    tempoDecorridoEmSegundos = 300
    alterarContexto('descanso-curto')
    botaoDeDescansoCurto.classList.add('active')
})

botaoDeDescansoLongo.addEventListener('click' , () => {
    tempoDecorridoEmSegundos = 900
    alterarContexto('descanso-longo')
    botaoDeDescansoLongo.classList.add('active')
})
